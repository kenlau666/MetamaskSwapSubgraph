...
export class AdapterRemoved extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save AdapterRemoved entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AdapterRemoved must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("AdapterRemoved", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AdapterRemoved | null {
    return changetype<AdapterRemoved | null>(
      store.get_in_block("AdapterRemoved", id.toHexString())
    );
  }

  static load(id: Bytes): AdapterRemoved | null {
    return changetype<AdapterRemoved | null>(
      store.get("AdapterRemoved", id.toHexString())
    );
  }
  ...
  get aggregatorId(): string {
    let value = this.get("aggregatorId");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set aggregatorId(value: string) {
    this.set("aggregatorId", Value.fromString(value));
  }
...
export class AdapterSet extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save AdapterSet entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AdapterSet must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("AdapterSet", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AdapterSet | null {
    return changetype<AdapterSet | null>(
      store.get_in_block("AdapterSet", id.toHexString())
    );
  }

  static load(id: Bytes): AdapterSet | null {
    return changetype<AdapterSet | null>(
      store.get("AdapterSet", id.toHexString())
    );
  }
